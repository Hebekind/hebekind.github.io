...
/* Smarty version 3.1.34-dev-7, created on 2022-01-18 14:15:09
  from '/home/u631248999/domains/hebekind.com/public_html/music/mobile/layout/my-tracks.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_61e6bd5dc46d63_77658126',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd7ff1e8eff1acd8ba23cb391009c8fc6fbe7d5d9' => 
    array (
      0 => '/home/u631248999/domains/hebekind.com/public_html/music/mobile/layout/my-tracks.html',
      1 => 1642509742,
      2 => 'file',
    ),
  ),
...
function content_61e6bd5dc46d63_77658126 (Smarty_Internal_Template $_smarty_tpl) {
ob_start();
...
if (count($_smarty_tpl->tpl_vars['this']->value->myCollections())) {?><div class="music_album_lst_w __nativeScroll" style="display: inherit;"><ul class="music_album_lst"><?php
...
}?><li class="music_album_i"><A class="mobmusic-album-a" href="/mmusic/collection/<?php echo $_smarty_tpl->tpl_vars['collection']->value['id'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></ul></div><?php }?><div class="music_track_lst-w"><div id="is_owner"></div><div class="mob_muss_add_tracks"><div class="mob_muss_add_ctt"><i class="plus_slideshow_photo"></i><span><?php echo $_smarty_tpl->tpl_vars['this']->value->lang['upload_music'];?>
</span></div><input type="file" class="post-html5-upload-file" onchange="uploadTracks(event,this);" name="files[]" accept="audio/*" multiple="multiple" id="tracks_files" /></div><ul class="music_track_lst"><?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['this']->value->myTracks(), 'track');
if ($_from !== null) {
...
?><div class="mobmus-empty"><?php echo $_smarty_tpl->tpl_vars['this']->value->lang['you_dont_have_tracks'];?>
</div><?php
}
