...
var pwa_url = "https://www.connectinchat.com/";
const staticAssets = [

    pwa_url+'/app.js',
   pwa_url+ '/themes/'+THEME+'/javascript/core.js?v=' + _version,
   pwa_url+ '/themes/'+THEME+'/javascript/jquery-3.1.1.min.js?v=' + _version,
   pwa_url+ '/themes/'+THEME+'/stylesheet/glyph.css?v=' + _version,
   pwa_url+ '/themes/'+THEME+'/stylesheet/style.css?v=' + _version,
   pwa_url+ '/themes/'+THEME+'/javascript/vaneayoung/clipboard.min.js?v=' + _version,
   pwa_url+ '/themes/'+THEME+'/javascript/vaneayoung/easytimer.min.js?v=' + _version,
   pwa_url+ '/themes/'+THEME+'/javascript/vaneayoung/liveNotifications.js?v=' + _version,
   pwa_url+ '/themes/'+THEME+'/javascript/vaneayoung/messenger-shortcut.js?v=' + _version,
   pwa_url+ '/themes/'+THEME+'/javascript/vaneayoung/messenger.js?v=' + _version,
   pwa_url+ '/themes/'+THEME+'/javascript/vaneayoung/peer.min.js?v=' + _version,
   pwa_url+ '/themes/'+THEME+'/javascript/vaneayoung/recorder.js?v=' + _version,
   pwa_url+ '/themes/'+THEME+'/javascript/vaneayoung/socket.io-1.2.0.js?v=' + _version,
   pwa_url+ '/themes/'+THEME+'/javascript/vaneayoung/soundmanager2-jsmin.js?v=' + _version,
   pwa_url+ '/themes/'+THEME+'/javascript/vaneayoung/system.js?v=' + _version,
   pwa_url+ '/themes/'+THEME+'/javascript/vaneayoung/tinysort.min.js?v=' + _version,
   pwa_url+ '/themes/'+THEME+'/javascript/vaneayoung/webrtc-calls.js?v=' + _version,
   pwa_url+ '/themes/'+THEME+'/javascript/vaneayoung/confirm-dialog/js/jquery-confirm.min.js?v=' + _version,
   pwa_url+ '/themes/'+THEME+'/javascript/vaneayoung/confirm-dialog/css/jquery-confirm.min.css?v=' + _version,
   pwa_url+ '/themes/'+THEME+'/javascript/vaneayoung/emojiarea/dist/emojionearea.min.css?v=' + _version,
   pwa_url+ '/themes/'+THEME+'/javascript/vaneayoung/emojiarea/dist/emojionearea.min.js?v=' + _version,
    pwa_url+'/themes/'+THEME+'/javascript/vaneayoung/emojiarea/dist/joypixels.min.js?v=' + _version,
    pwa_url+'/themes/'+THEME+'/javascript/vaneayoung/lightgallery/css/lightgallery.min.css?v=' + _version,
    pwa_url+'/themes/'+THEME+'/javascript/vaneayoung/lightgallery/js/lightgallery.min.js?v=' + _version,
    pwa_url+'/themes/'+THEME+'/javascript/vaneayoung/nanoScroll/css/nanoscroller.css?v=' + _version,
    pwa_url+'/themes/'+THEME+'/javascript/vaneayoung/nanoScroll/javascripts/overthrow.min.js?v=' + _version,
   pwa_url+ '/themes/'+THEME+'/javascript/vaneayoung/nanoScroll/javascripts/jquery.nanoscroller.min.js?v=' + _version,
	pwa_url+'/themes/'+THEME+'/javascript/vaneayoung/timeago.min.js?v=' + _version
];
