...
function messengerPage() {
	...
	let ch_msgr = setInterval(function(){
...
__j(document).ready(function(){
 		if(is_smartphone()){
		//__j('#js_emojionearea').attr('src',THEME_URL+'/javascript/vaneayoung/emojionearea.mob.js?v='+Math.random());
		//__j('#css_emojionearea').attr('href',THEME_URL+'/stylesheet/vaneayoung/emojioneare.mob.css?v='+Math.random());
		__j('#js_emojionearea').after('<script type="text/javascript" src="'+THEME_URL+'/javascript/vaneayoung/emojionearea.mob.js?v='+Math.random()+'"><\/script>');
		__j('#css_emojionearea_desktop').attr('disabled',true);
		//__j('#css_emojionearea_mob').removeAttr('disabled');
		
		$('head').append( $('<link rel="stylesheet" type="text/css" />').attr('href', THEME_URL+'/stylesheet/vaneayoung/emojioneare.mob.css?v='+Math.random()) );
