...
require_once(getcwd().'/assets/vaneayoung/config.php');
require_once(getcwd().'/assets/vaneayoung/libraries/Embera/vendor/autoload.php');
require_once(getcwd().'/assets/vaneayoung/libraries/emojione/autoload.php');
require_once(getcwd().'/assets/vaneayoung/libraries/smarty-3.1.34/Smarty.class.php');
require_once(getcwd().'/assets/vaneayoung/libraries/json-db/json-db.class.php');
require_once(getcwd().'/assets/vaneayoung/classes/class.cronjob.php');
...
public function __construct(){
 ...
 global $wo,$svgI;
	...
	$this->theme_dir = getcwd()."/assets/vaneayoung/layout";
	$this->settings = SETTINGS;
	$this->db_path = $_SERVER['DOCUMENT_ROOT']."/assets/vaneayoung/lib/db/";
	$this->svgs = $svgI;
	...
	$mess_language = include(getcwd()."/assets/vaneayoung/lang/{$global_language}.php");
