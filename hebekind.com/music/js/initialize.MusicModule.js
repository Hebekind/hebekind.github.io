            ...
            if (popup_music_is_constructed == false) {
                ...
                jQuery.ajax({
                    ...
                    success: function(data) {
                        ...
                        jQuery.ajax({
                            url: '/music/javascript/musicModule.js?v=1',
                            cache: false,
                            async: true,
                            dataType: 'script',
                            success: function() {
